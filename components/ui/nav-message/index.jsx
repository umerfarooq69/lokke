...
const NavMessage = () =>
  <DropDown className="grid rounded-[10px] px-[10px] py-[5px] bg-white absolute right-[-10px] top-[calc(100%+5px)] border border-border-primary min-w-[350px]" label={<Message />}>
