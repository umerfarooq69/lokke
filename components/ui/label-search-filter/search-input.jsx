...
const TopSearch = ({ open }) =>
  <div className="relative">
    ...
    <input className={`border ${open ? 'border-[#000] ' : 'border-[#ECEDF1] '} min-w-[276px] h-[48px] rounded-[64px] pl-[46px] outline-none placeholder:text-text-secondary`} name="search" placeholder="Search Location" type="text" />
  </div>;
